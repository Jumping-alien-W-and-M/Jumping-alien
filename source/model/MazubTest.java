...
public class MazubTest {
	...
	public void TestBasicConstructorCorrectParameters() {
		assertEquals(basic_alien.getX(), 0);
		assertEquals(basic_alien.getY(), 0);
	...
	public void TestCoordinateSettersCorrectParameters() {
		...
		basic_alien.setX(10);
		assertEquals(basic_alien.getX(), 10);
		basic_alien.setY(100);
		assertEquals(basic_alien.getY(), 100);
		...
		assertEquals(basic_alien.getX(), 1023);
		basic_alien.setY(767);
		assertEquals(basic_alien.getY(), 767);
	...
	public void TestadvanceTimeupdatingxpositionnewxoutsidebounds(){
		...
		basic_alien.setVx(1);
		basic_alien.setAx(1);
		basic_alien.setX(Mazub.getWorldWidth()-1);
		basic_alien.advanceTime(0.1);
		assert(basic_alien.getX() == Mazub.getWorldWidth()-1);
	}
	...
	public void TestadvanceTimeupdatingypositionnewyoutsidebounds(){
		...
		basic_alien.setVy(1);
		basic_alien.setY(Mazub.getWorldHeight()-1);
		basic_alien.advanceTime(0.1);
		assert(basic_alien.getY() == Mazub.getWorldHeight()-1);
	}
